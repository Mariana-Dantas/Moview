...
public class FavoriteDbHelper extends SQLiteOpenHelper {
    ...
    public void addFavorite(Movie movie) {
        ...
        values.put(FavoriteContract.FavoriteEntry.COLUMN_MOVIEID, movie.getMovieId());
    ...
    public List<Movie> getAllFavorite() {
        ...
        if (cursor.moveToFirst()) {
            do {
                ...
                movie.setMovieID(Integer.parseInt(cursor.getString(cursor.getColumnIndex(FavoriteContract.FavoriteEntry.COLUMN_MOVIEID))));
